...
#include "nrutil.h"
#include "nr.h"
#define NAME (char *)("Prey")  //Give your set of ODE's a name
#define NUM 2  //Number of ODE's
#define XINIT {30, 3}  //Initial conditions
...
void deriv(double t, double x[], double dxdt[]){
  ...
  dxdt[1] = 1*x[1]-0.1*x[1]*x[2]-d*x[1];
  dxdt[2] = -1.5*x[2]+0.03*x[1]*x[2]-e*x[2];
